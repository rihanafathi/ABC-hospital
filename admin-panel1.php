...
if(isset($_POST['docsub']))
{
  ...
  $query1="insert into users(username,password,role)values('$doctor','$dpassword','doctor')";
...
if (isset($_POST['addrec'])) {
  ...
  $query1 = "INSERT INTO users (username, password, role) VALUES (?, ?, 'receptionist')";
  $stmt1 = mysqli_prepare($con, $query1);
  mysqli_stmt_bind_param($stmt1, "ss", $name, $rpassword);
  ...
  if (mysqli_stmt_affected_rows($stmt1) > 0) {
      ...
      $query2 = "INSERT INTO receptionist (name, gender, email, address, contactNo, user_id) VALUES (?, ?, ?, ?, ?, ?)";
      $stmt2 = mysqli_prepare($con, $query2);
      mysqli_stmt_bind_param($stmt2, "sssssi", $name, $gender, $remail, $raddress, $rcontact,  $user_id);
      mysqli_stmt_execute($stmt2);

      if (mysqli_stmt_affected_rows($stmt2) > 0) {
          echo "<script>alert('Receptionist added successfully!');</script>";
      } else {
          echo "<script>alert('Error adding receptionist!');</script>";
      }
  } else {
...
<head>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
        ...
        <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> ABC Hospital </a>
        ...
        <div class="row">
            <div class="col-md-4" style="max-width:25%;margin-top: 3%;">
                <div class="list-group" id="list-tab" role="tablist">
                    ...
                    <a class="list-group-item list-group-item-action" href="#list-recep" id="list-recep-list" role="tab"
                        data-toggle="list" aria-controls="home">Receptionist List</a>
                    ...
                    <a class="list-group-item list-group-item-action" href="#list-adrec" id="list-adrec-list" role="tab"
                        data-toggle="list" aria-controls="home">Add Receptionist</a>
            ...
            <div class="col-md-8" style="margin-top: 3%;">
                <div class="tab-content" id="nav-tabContent" style="width: 950px;">
                  ...
                  ?>
                    ...
                    <div class="tab-pane fade" id="list-recep" role="tabpanel" aria-labelledby="list-recep-list">
                      ...
                      while ($row = mysqli_fetch_array($result)) {
                          ...
                          echo "<tr>
                              ...
                              <td>$address</td>
                              <td>
                                  <form method='POST' action='delete_receptionist.php' style='display:inline;'>
        ...
        <tr>
            ...
            <td>
                                    <?php 
                                                ...
                                                else   if(($row['userStatus']==2) && ($row['doctorStatus']==1))  
                                                {
                                                echo "Cancelled";
                                                }
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <select name="gender" class="form-control" id="gender" required="required">
                                        <option value="head" name="gender" disabled selected>Select Gender</option>
                                ...
                                <div class="col-md-4"><label>Email ID:</label></div>
                                <div class="col-md-8"><input type="email" class="form-control" name="remail" required>
                                </div><br><br>

                                <div class="col-md-4"><label>Contact No:</label></div>
                                <div class="col-md-8"><input type="text" class="form-control" name="rcontact"
                                        id="rcontact" required></div><br><br>

                                <div class="col-md-4"><label>Address:</label></div>
                                <div class="col-md-8"><input type="text" class="form-control" name="raddress"
                                        id="raddress" required></div><br><br>

                                <div class="col-md-4"><label>Password:</label></div>
                                <div class="col-md-8"><input type="password" class="form-control" onkeyup='check();'
                                        name="rpassword" id="rpassword" required></div><br><br>

                            </div>
                            <input type="submit" name="addrec" value="Add Receptionist" class="btn btn-primary">
                        </form>
                    </div>
